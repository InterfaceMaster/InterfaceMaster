 ...
 */
static W25Q_State_e w25q_write_enable(void) {
...
static W25Q_State_e w25q_write_disable(void) {
  HAL_StatusTypeDef status;
...
static W25Q_State_e w25q_read_status_reg_1(uint8_t *p_data_buff) {
  HAL_StatusTypeDef status;
